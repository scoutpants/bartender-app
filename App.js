...
const drinkDatabase = [
  ...
  { name: "Whiskey Julep", base: "Whiskey/Bourbon", liqueur: "None", flavor: "Herbal", strength: "Strong", description: "Refreshing whiskey elegance with mint's cooling embrace. Whiskey's warm character enhanced by fresh mint's herbal freshness and sugar's gentle sweetness. Cool, refreshing with a smooth, contemplative finish. Summer's whiskey companion.", ingredients: ["2 oz Whiskey", "6-8 Mint leaves", "2 tsp Sugar", "Crushed ice"] },
  { name: "Whiskey Smash", base: "Whiskey/Bourbon", liqueur: "None", flavor: "Herbal", strength: "Medium", description: "Bright whiskey refreshment with mint and citrus harmony. Whiskey's warm character enhanced by fresh mint's herbal notes and lemon's tart brightness. Refreshing, herbaceous with a clean, citrus-forward finish. Perfect for warm evenings.", ingredients: ["2 oz Whiskey", "6-8 Mint leaves", "0.5 oz Simple syrup", "0.5 oz Lemon juice"] },
  { name: "Old Fashioned", base: "Whiskey/Bourbon", liqueur: "None", flavor: "Sweet", strength: "Strong", description: "The quintessential whiskey cocktail. Rich bourbon or rye enhanced by aromatic bitters and a whisper of sweetness. Bold whiskey character mellowed by muddled sugar, revealing notes of caramel, vanilla, and oak. Robust yet refined with a warming, contemplative finish. Garnished with an expressed orange peel for aromatic citrus oils.", ingredients: ["2 oz Bourbon or rye whiskey", "1 sugar cube or 0.25 oz Simple syrup", "2 dashes Angostura bitters", "Orange peel"] },
  { name: "Bourbon Old Fashioned", base: "Whiskey/Bourbon", liqueur: "None", flavor: "Sweet", strength: "Strong", description: "A classic Old Fashioned specifically prepared with bourbon. Rich bourbon enhanced by aromatic bitters and a touch of sweetness. Notes of vanilla, caramel, and oak shine with a citrus oil finish.", ingredients: ["2 oz Bourbon", "1 sugar cube or 0.25 oz Simple syrup", "2 dashes Angostura bitters", "Orange peel"] },
...
export default function App() {
  ...
  const allBaseSpirits = [
    ...
    'Whiskey/Bourbon', 'Scotch', 'Irish Whiskey',
